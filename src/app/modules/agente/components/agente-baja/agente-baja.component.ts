...
export class AgenteBajaComponent {
    ...
    @ViewChild(AgenteBajaFormComponent)
    bajaFormComponent: AgenteBajaFormComponent;
    ...
    public guardar() {
        ...
        this.agenteService.baja(this.agente, datosBaja).subscribe(
            (agente) => {
                ...
                this.bajaFormComponent.datosNormaLegal.fileManager.saveFileChanges(
