...
const routes: Routes = [
    ...
    { path: 'configuracion/feriados/editar/:id', component: FeriadoCreateUpdateComponent, canActivate: [RoutingNavBar , RoutingGuard] },
    ...
    { path: 'configuracion/regimen-horarios', component: RegimenHorarioListComponent, canActivate: [RoutingNavBar , RoutingGuard] },
    { path: 'configuracion/regimen-horarios/crear', component: RegimenHorarioCreateUpdateComponent, canActivate: [RoutingNavBar , RoutingGuard] },
    ...
    { path: 'configuracion/licencia-periodos/crear', component: LicenciaPeriodoCreateUpdateComponent, canActivate: [RoutingNavBar , RoutingGuard] },
