...
@Component({
    selector: 'app-hora-extra-search-form',
    templateUrl: 'hora-extra-search.html',
})
export class HoraExtraSearchFormComponent extends ABMSearchComponent{
    ...
    public async ngOnInit() {
        this.canProcesarRecargo = await this.authService.check('horas_extras:hora_extra:procesar_hora_extra');
